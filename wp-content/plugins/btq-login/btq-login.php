...
<!-- Button trigger modal -->
      ...
      <ul class="mega-menu">
        ...
        <li><a id="botones" type="button" onclick="pestaña_registro()" class="btn btn-primary" data-toggle="modal" data-target="#exampleModalCenter2" onclick="closeNav()">Registro</a></li>  
      </ul>
