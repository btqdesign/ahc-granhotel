...
function btq_booking_tc_grid_form($language = 'es') {
	...
	?>
		...
		<section class="row">
			...
			<article class="col-md-4">
				<input type="text" onfocus="(this.type='date')" class="col-xs-6" id="entrada" name="entrada" placeholder="<?php _e('Entry date','btq-booking-tc'); ?>">
				<input type="text" onfocus="(this.type='date')" class="col-xs-6" id="salida" name="salida" placeholder="<?php _e('Departure date','btq-booking-tc'); ?>">			
				<div class="clearfix visible-xs-block"></div>	
			</article>
